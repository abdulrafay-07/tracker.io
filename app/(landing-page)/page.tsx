...
const Home = () => {
  return (
    <div className='h-full flex justify-center items-center text-neutral-900 px-4 md:px-8 mt-32 2xl:mt-40'>
      <div className='flex flex-col gap-8 lg:gap-4 lg:flex-row lg:justify-evenly h-full w-full'>
        ...
        <div className='lg:w-2/5 flex items-start md:p-3 md:rounded-xl md:shadow-2xl'>
          <video
            src={'/landing.mp4'}
